...
BarWidget {
  id: root
  moduleName: "alon.media"

  readonly property var mediaService: bar?.shell?.serviceFor("alon.media")
  ...
  property real maxLabelWidth: 500

  visible: hasMedia
  implicitWidth: hasMedia ? row.implicitWidth + Style.space(36) : 0
